...
public:
	virtual bool AddVerts(LPVOID pVerticesBuffer, int nVertCount, A3DVERTEXTYPE vertexType) = 0;
	virtual bool AddFaces(LPVOID pIndicesBuffer, int nFaceCount, A3DFORMAT indexFormat) = 0;
...
public:
	virtual bool AddVerts(LPVOID pVertices, int nVertCount, A3DVERTEXTYPE vertexType) = 0;
	virtual bool AddFaces(LPVOID pIndices, int nFaceCount, A3DFORMAT indexFormat) = 0;
...
public:
	virtual bool AddVerts(LPVOID pVertices, int nVertCount, A3DVERTEXTYPE vertexType);
	virtual bool AddFaces(LPVOID pIndices, int nFaceCount, A3DFORMAT indexFormat);
