...
//	Image model action
typedef struct _IMGMODELACTION
{
...
} IMGMODELACTION, *PIMGMODELACTION; 

typedef struct _IMGMODELCELL
{
...
public:		//	Operations
	...
	void		UpdateShape(A3DCamera* pCamera);	//	Update shape
