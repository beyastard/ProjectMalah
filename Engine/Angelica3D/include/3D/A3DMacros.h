...
#define A3DPLANE_UNKNOWN	9		//	unknown
...
#define CLAMPVALUE(x, a, b)	if ((x) < (a))	(x) = (a);	else if ((x) > (b))	(x) = (b);
#define CLAMPMAXVALUE(x, a) if ((x) > (a))	(x) = (a);
#define CLAMPMINVALUE(x, a) if ((x) < (a))	(x) = (a);
