...
class A3DGFXMan : public A3DData
{
private:
	...
	AFileImage * 	FindFileImage(char * szFileName);
...
public:
	...
	bool LoadGFXFromFile(char * szGFXFile, A3DModel * pModel, char * szParentFrameName, bool bLinked, A3DGraphicsFX ** ppGFX, 
	...
	bool ReleaseGFX(PA3DGraphicsFX& pGFX);

	// Remove the reference in m_GFXList, but not release it;
	bool DeleteGFX(PA3DGraphicsFX& pGFX);

	inline void SetFolderName(char * szFolderName) 
	{ 
		strcpy(m_szFolderName, szFolderName); 
