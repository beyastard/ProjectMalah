...
typedef struct _SUPDECALKEYPOINT
{
...
} SUPDECALKEYPOINT, *PSUPDECALKEYPOINT;
...
public:		//	Operations
	...
	bool		Render(A3DViewport* pView); // Rneder function;
	...
	int			GetRepeatTime()				
	{	
		return (m_bTexRepeat ? -1 : 1) * m_iRepTime;	
	}
