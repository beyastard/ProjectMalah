...
bool AList::Append(LPVOID pDataToAppend, ALISTELEMENT ** ppElement)
{
	return Insert(pDataToAppend, m_pTail, ppElement);
}
	
bool AList::Insert(LPVOID pDataToInsert, ALISTELEMENT * pElement, ALISTELEMENT ** ppElement)
{
...
bool AList::Insert(LPVOID pDataToInsert, LPVOID pDataInsertBefore, ALISTELEMENT ** ppElement)
{
