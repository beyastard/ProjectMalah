...
#ifndef _VSSETROUTELOADER_H_
#define _VSSETROUTELOADER_H_
...
*/
int	CVSSetRouteLoader::GetFirstSampleOfSection(int iSection)
{
	if (!m_bReady)
		return -1;
...
/*	Get the last sample of specified section
	...
	iSection: specified section's index
*/
int	CVSSetRouteLoader::GetLastSampleOfSection(int iSection)
{
	if (!m_bReady)
		return -1;
...
/*	Get visible surface number of specified section
	...
	iSection: specified section's index
*/
int	CVSSetRouteLoader::GetVisibleSurfaceNumber(int iSection)
{
	if (!m_bReady)
		return -1;
